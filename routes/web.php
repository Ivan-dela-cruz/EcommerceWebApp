...
Route::get('user/activate/{id}','FrontendController@session')->name('register.activate');
// Reset password
...
Route::get('order/pdf/{id}','OrderController@generatePdf')->name('order.pdf');
...
Route::group(['prefix'=>'/admin','middleware'=>['auth','admin']],function(){
    ...
    Route::get('suppliers-report','SuppliersController@pdf')->name('suppliers.pdf');
    //milk record route
