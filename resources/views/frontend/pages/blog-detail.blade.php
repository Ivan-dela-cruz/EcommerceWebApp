                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Detalle de Blog</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <p class="text-center p-5">
                                Necesita <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Iniciar sesión</a> OR <a style="color:blue" href="{{route('register.form')}}">Registrarse</a> para comentar.
