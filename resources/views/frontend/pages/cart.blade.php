...
@section('title','Aspralnues Carrito')
							...
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="{{route('coupon-store')}}" method="POST">
											@csrf
											<input name="code" placeholder="Ingrese el Cupón">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Ud. Paga<span>${{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Ud. Paga<span>${{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
