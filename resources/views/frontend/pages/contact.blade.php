									...
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="name" id="name" type="text" placeholder="Ingrese su Nombre">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Asunto<span>*</span></label>
												<input name="subject" type="text" id="subject" placeholder="Ingrese su asunto">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Correo<span>*</span></label>
												<input name="email" type="email" id="email" placeholder="Ingrese su Correo">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Teléfono<span>*</span></label>
												<input id="phone" name="phone" type="number" placeholder="Ingrese su Teléfono">
											</div>
										</div>
										<div class="col-12">
											<div class="form-group message">
												<label>Mensaje<span>*</span></label>
												<textarea name="message" id="message" cols="30" rows="9" placeholder="Ingrese su Mensaje"></textarea>
											</div>
										</div>
										<div class="col-12">
...
{{--	</div>--}}
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
				<h2 class="text-warning">¡Lo sientimos!</h2>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
