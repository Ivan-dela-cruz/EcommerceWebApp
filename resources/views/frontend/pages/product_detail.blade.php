										...
										<div class="product-info">
											<div class="nav-main">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													...
													<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#reviews" role="tab">Revisiones</a></li>
												</ul>
												<!--/ End Tab Nav -->
											</div>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
                                                                    Necesita <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Iniciar sesión</a> OR <a style="color:blue" href="{{route('register.form')}}">Registrarse</a>
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" href="#"><i class=" ti-eye"></i><span>Compra Rápida</span></a>
                                                <a  href="#"><i class=" ti-heart "></i><span>Añadir a la lista de deseos</span></a>
                                                <a  href="#"><i class="ti-bar-chart-alt"></i><span>Añadir a comparar</span></a>
                                            </div>
