...
@if(count($banners)>0)
<section style="height: 510px" id="Gslider" class="carousel slide" data-ride="carousel">
    ...
    <div style="height: 510px" class="carousel-inner" role="listbox">
        @foreach($banners as $key=>$banner)
        <div style="height: 510px" class="carousel-item {{(($key==0)? 'active' : '')}}">
            <img style="height: 510px" class="first-slide" src="{{$banner->photo}}" alt="First slide">
            <div {{$banner->caption?'':'hidden'}} class="carousel-caption text-left">
                <h1 class="wow fadeInDown">{{$banner->title}}</h1>
                <p>{!! html_entity_decode($banner->description) !!}</p>
                <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{route('product-grids')}}" role="button">Compra
                    Ahora<i class="far fa-arrow-alt-circle-right"></i></i></a>
            </div>
        </div>
        @endforeach
    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            <a data-toggle="modal" data-target="#{{$product->id}}" title="Vista rápida"
                                                href="#"><i class=" ti-eye"></i><span>Compra Rápida</span></a>
                                            <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}"><i
                                                    class=" ti-heart "></i><span>Añadir a la lista de deseos</span></a>
                                        </div>
                                        <div class="product-action-2">
                                            <a title="Agregar al carrito"
                                                href="{{route('add-to-cart',$product->slug)}}">Agregar al carrito</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="product-img">
                            ...
                            <div class="button-head">
                                <div class="product-action">
                                    ...
                                    <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}"><i
                                            class=" ti-heart "></i><span>Agregar a la lista</span></a>
                                </div>
                                <div class="product-action-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">{{number_format($product->discount,2)}}% DESC</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
        ...
        if(width_w < 767){
            $('#slider-single').attr('hidden',false);
            $('#Gslider').attr('hidden',true);
            $('#logoprincipal').attr('height',100);
            $('#logoprincipal').attr('width',100);
        }else{
            $('#slider-single').attr('hidden',true);
            $('#Gslider').attr('hidden',false);
            $('#logoprincipal').removeAttr('height');
            $('#logoprincipal').removeAttr('width');
        }
    })
    var width_w = window.innerWidth
