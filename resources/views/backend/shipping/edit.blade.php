...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('shipping.update',$shipping->id)}}">
        ...
        <input id="inputTitle" type="text" name="type" placeholder="Ingrese el Tipo"  value="{{$shipping->type}}" class="form-control">
        @error('title')
        ...
        <input id="price" type="number" name="price" placeholder="Ingrese el Precio"  value="{{$shipping->price}}" class="form-control">
        @error('price')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
