    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Ingrese el descuento"  value="{{old('discount')}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="quantity" type="number" name="stock" min="0" placeholder="Ingrese la cantidad"  value="{{old('stock')}}" class="form-control">
          @error('stock')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
    ...
    if(cat_id !=null){
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          var html_option="<option value=''>----Seleccionar----</option>"
          if(response.status){
