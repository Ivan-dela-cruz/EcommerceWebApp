...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('users.update',$user->id)}}">
        ...
        <input id="inputTitle" type="text" name="name" placeholder="Ingresar el nombre"  value="{{$user->name}}" class="form-control">
        @error('name')
        ...
        <div class="form-group">
          ...
          <input id="inputEmail" type="email" name="email" placeholder="Ingresar el correo"  value="{{$user->email}}" class="form-control">
          @error('email')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
