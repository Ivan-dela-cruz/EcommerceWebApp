    ...
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="code" placeholder="Ingrese el cupón"  value="{{$coupon->code}}" class="form-control">
          @error('code')
          ...
          <div class="form-group">
              ...
              <input id="inputTitle" type="number" name="value" placeholder="Ingrese el valor"  value="{{$coupon->value}}" class="form-control">
              @error('value')
              <span class="text-danger">{{$message}}</span>
              @enderror
          </div>
