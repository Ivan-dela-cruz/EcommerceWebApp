    ...
    <div class="card-body">
      <form method="post" action="{{route('post-category.update',$postCategory->id)}}">
        ...
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">T´titulo</label>
          <input id="inputTitle" type="text" name="title" placeholder="Ingrese el título"  value="{{$postCategory->title}}" class="form-control">
          @error('title')
